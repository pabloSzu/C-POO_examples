...
Visual::Visual() : Ogl(), x(0), y(0), z(0), rotacion_hacia_laterales(0), rotacion_arriba_abajo(0),
                   mouse_x(0), mouse_y(0)  {
...
void Visual::paintGL()  {
    ...
    //this->dibujarPlanoVertical(45, 10, -99, 10, 5, idTexturaCamara[0]);

    glEnable(GL_TEXTURE_2D);	// Activamos la texturizacion
    glBindTexture(GL_TEXTURE_2D, idTexturaCamara[0]);	// Activamos la textura con idTextura

    glBegin(GL_QUADS);
        glTexCoord2f(0, 0); glVertex3f(45, 15, -99);
        glTexCoord2f(1, 0); glVertex3f(55, 15, -99);
        glTexCoord2f(1, 1); glVertex3f(55, 10, -99);
        glTexCoord2f(0, 1); glVertex3f(45, 10, -99);
    glEnd();
