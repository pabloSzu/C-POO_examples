...
Visual::Visual() : Ogl(), x(0), y(0), z(0), rotacion_hacia_laterales(0), rotacion_arriba_abajo(0), rotacionVentilador(0),
                   mouse_x(0), mouse_y(0)  {
...
void Visual::paintGL()  {
    ...
    glTranslatef(73,3.5,70);

    glRotatef(40, -15,20,0);

    this->dibujarPlanoVertical(-0.4,-4,0, 0.7,3.8, idTexturas[4]);

    glRotatef(-40, -15,20,0);

    glRotatef(90, 1,0,-0.7);
    glRotatef(rotacionVentilador,0,-1,0);

    this->dibujarPlanoHorizontal(-0.4,0.1,-0.5, 1,3, idTexturas[3], 1,1);
    this->dibujarPlanoHorizontal(-0.4,0.1,3.5, 1,3, idTexturas[3], 1,1);
    this->dibujarPlanoHorizontal(0.6, 0.1, 0.5, 3,1, idTexturas[3], 1,1);
    this->dibujarPlanoHorizontal(-3.5,0.1,0.5, 3,1, idTexturas[3], 1,1);

    rotacionVentilador+= 10;
    if(rotacionVentilador == 360)
        rotacionVentilador = 0;
